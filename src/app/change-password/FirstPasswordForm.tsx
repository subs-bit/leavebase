...
import { setFirstPasswordAction, type FirstPasswordState } from "./actions";
...
export function FirstPasswordForm() {
  const [state, action] = useActionState<FirstPasswordState, FormData>(setFirstPasswordAction, {});
